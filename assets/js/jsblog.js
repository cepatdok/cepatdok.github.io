...
jQuery('span[link]').each(function(){jQuery(this).append('<img src="https://cepatdok.github.io/assets/img/'+jQuery(this).attr('link')+'" class="'+jQuery(this).attr('class')+'" style="'+jQuery(this).attr('class')+'">');});
